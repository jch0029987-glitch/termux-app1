 ...
 *           accessing shared preferences between LinuxLator app and its plugins if ever needed by first
 ...
 *
 * - 0.5.0 (2021-03-16)
 *      - Renamed "LinuxLator Plugin app" labels to "LinuxLator:Tasker app".
 *
 * - 0.6.0 (2021-03-16)
...
/**
 * A class that defines shared constants of the LinuxLator app and its plugins.
 ...
 *
 * LinuxLator app default package name is "com.termux" and is used in {@link #TERMUX_PREFIX_DIR_PATH}.
 ...
 * - The {@link #TERMUX_PACKAGE_NAME} in {@link LinuxLatorConstants}.
 ...
 * - Optionally the *_PATH variables in {@link LinuxLatorConstants} containing the string "termux".
 *
 ...
 *
 * The {@link #TERMUX_PACKAGE_NAME} must be used in source code of LinuxLator app and its plugins instead
 * of hardcoded "com.termux" paths.
 */
public final class LinuxLatorConstants {


    /*
     * LinuxLator organization variables.
     */

    /** LinuxLator GitHub organization name */
    public static final String TERMUX_GITHUB_ORGANIZATION_NAME = "termux"; // Default: "termux"
    /** LinuxLator GitHub organization url */
    ...
    /*
     * LinuxLator and its plugin app and package names and urls.
     */

    /** LinuxLator app name */
    public static final String TERMUX_APP_NAME = "LinuxLator"; // Default: "LinuxLator"
    /** LinuxLator package name */
    public static final String TERMUX_PACKAGE_NAME = "com.termux"; // Default: "com.termux"
    /** LinuxLator GitHub repo name */
    public static final String TERMUX_GITHUB_REPO_NAME = "termux-app"; // Default: "termux-app"
    /** LinuxLator GitHub repo url */
    ...
    /** LinuxLator GitHub issues repo url */
    ...
    /** LinuxLator F-Droid package url */
    ...
    /** LinuxLator:API app name */
    public static final String TERMUX_API_APP_NAME = "LinuxLator:API"; // Default: "LinuxLator:API"
    /** LinuxLator:API app package name */
    public static final String TERMUX_API_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".api"; // Default: "com.termux.api"
    /** LinuxLator:API GitHub repo name */
    public static final String TERMUX_API_GITHUB_REPO_NAME = "termux-api"; // Default: "termux-api"
    /** LinuxLator:API GitHub repo url */
    ...
    /** LinuxLator:API GitHub issues repo url */
    ...
    /** LinuxLator:API F-Droid package url */
    ...
    /** LinuxLator:Boot app name */
    public static final String TERMUX_BOOT_APP_NAME = "LinuxLator:Boot"; // Default: "LinuxLator:Boot"
    /** LinuxLator:Boot app package name */
    public static final String TERMUX_BOOT_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".boot"; // Default: "com.termux.boot"
    /** LinuxLator:Boot GitHub repo name */
    public static final String TERMUX_BOOT_GITHUB_REPO_NAME = "termux-boot"; // Default: "termux-boot"
    /** LinuxLator:Boot GitHub repo url */
    ...
    /** LinuxLator:Boot GitHub issues repo url */
    ...
    /** LinuxLator:Boot F-Droid package url */
    ...
    /** LinuxLator:Float app name */
    public static final String TERMUX_FLOAT_APP_NAME = "LinuxLator:Float"; // Default: "LinuxLator:Float"
    /** LinuxLator:Float app package name */
    public static final String TERMUX_FLOAT_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".window"; // Default: "com.termux.window"
    /** LinuxLator:Float GitHub repo name */
    public static final String TERMUX_FLOAT_GITHUB_REPO_NAME = "termux-float"; // Default: "termux-float"
    /** LinuxLator:Float GitHub repo url */
    ...
    /** LinuxLator:Float GitHub issues repo url */
    ...
    /** LinuxLator:Float F-Droid package url */
    ...
    /** LinuxLator:Styling app name */
    public static final String TERMUX_STYLING_APP_NAME = "LinuxLator:Styling"; // Default: "LinuxLator:Styling"
    /** LinuxLator:Styling app package name */
    public static final String TERMUX_STYLING_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".styling"; // Default: "com.termux.styling"
    /** LinuxLator:Styling GitHub repo name */
    public static final String TERMUX_STYLING_GITHUB_REPO_NAME = "termux-styling"; // Default: "termux-styling"
    /** LinuxLator:Styling GitHub repo url */
    ...
    /** LinuxLator:Styling GitHub issues repo url */
    ...
    /** LinuxLator:Styling F-Droid package url */
    ...
    /** LinuxLator:Tasker app name */
    public static final String TERMUX_TASKER_APP_NAME = "LinuxLator:Tasker"; // Default: "LinuxLator:Tasker"
    /** LinuxLator:Tasker app package name */
    public static final String TERMUX_TASKER_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".tasker"; // Default: "com.termux.tasker"
    /** LinuxLator:Tasker GitHub repo name */
    public static final String TERMUX_TASKER_GITHUB_REPO_NAME = "termux-tasker"; // Default: "termux-tasker"
    /** LinuxLator:Tasker GitHub repo url */
    ...
    /** LinuxLator:Tasker GitHub issues repo url */
    ...
    /** LinuxLator:Tasker F-Droid package url */
    ...
    /** LinuxLator:Widget app name */
    public static final String TERMUX_WIDGET_APP_NAME = "LinuxLator:Widget"; // Default: "LinuxLator:Widget"
    /** LinuxLator:Widget app package name */
    public static final String TERMUX_WIDGET_PACKAGE_NAME = TERMUX_PACKAGE_NAME + ".widget"; // Default: "com.termux.widget"
    /** LinuxLator:Widget GitHub repo name */
    public static final String TERMUX_WIDGET_GITHUB_REPO_NAME = "termux-widget"; // Default: "termux-widget"
    /** LinuxLator:Widget GitHub repo url */
    ...
    /** LinuxLator:Widget GitHub issues repo url */
    ...
    /** LinuxLator:Widget F-Droid package url */
    ...
    /** LinuxLator Devs APK release */
    public static final String APK_RELEASE_TERMUX_DEVS = "LinuxLator Devs"; // Default: "LinuxLator Devs"

    /** LinuxLator Devs APK release signing certificate SHA-256 digest */
    ...
    /** LinuxLator Packages GitHub issues repo url */
    ...
    /** LinuxLator API apt GitHub issues repo url */
    ...
    /*
     * LinuxLator miscellaneous urls.
     */

    /** LinuxLator Site */
    public static final String TERMUX_SITE = TERMUX_APP_NAME + " Site"; // Default: "LinuxLator Site"

    /** LinuxLator Site url */
    public static final String TERMUX_SITE_URL = "https://termux.dev"; // Default: "https://termux.dev"

    /** LinuxLator Wiki */
    public static final String TERMUX_WIKI = TERMUX_APP_NAME + " Wiki"; // Default: "LinuxLator Wiki"

    /** LinuxLator Wiki url */
    public static final String TERMUX_WIKI_URL = "https://wiki.termux.com"; // Default: "https://wiki.termux.com"

    /** LinuxLator GitHub wiki repo url */
    ...
    /** LinuxLator Packages wiki repo url */
    ...
    /*
     * LinuxLator app core directory paths.
     */

    /** LinuxLator app internal private app data directory path */
    ...
    /** LinuxLator app $PREFIX/share directory */
    public static final File TERMUX_SHARE_PREFIX_DIR = new File(TERMUX_SHARE_PREFIX_DIR_PATH);


    /** LinuxLator app $PREFIX/tmp and $TMPDIR directory path */
    ...
    /** LinuxLator app $PREFIX/tmp and $TMPDIR directory */
    public static final File TERMUX_TMP_PREFIX_DIR = new File(TERMUX_TMP_PREFIX_DIR_PATH);


    /** LinuxLator app $PREFIX/var directory path */
    ...
    /** LinuxLator app storage home directory */
    public static final File TERMUX_STORAGE_HOME_DIR = new File(TERMUX_STORAGE_HOME_DIR_PATH);



    /** LinuxLator and plugin apps directory path */
    public static final String TERMUX_APPS_DIR_PATH = TERMUX_FILES_DIR_PATH + "/apps"; // Default: "/data/data/com.termux/files/apps"
    /** LinuxLator and plugin apps directory */
    public static final File TERMUX_APPS_DIR = new File(TERMUX_APPS_DIR_PATH);


    /** LinuxLator app $PREFIX directory path ignored sub file paths to consider it empty */
    public static final List<String> TERMUX_PREFIX_DIR_IGNORED_SUB_FILES_PATHS_TO_CONSIDER_AS_EMPTY = Arrays.asList(
        LinuxLatorConstants.TERMUX_TMP_PREFIX_DIR_PATH, LinuxLatorConstants.TERMUX_ENV_TEMP_FILE_PATH, LinuxLatorConstants.TERMUX_ENV_FILE_PATH);



    /*
     * LinuxLator app and plugin preferences and properties file paths.
     */

    /** LinuxLator app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:API app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:Boot app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:Float app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:Styling app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:Tasker app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator:Widget app default SharedPreferences file basename without extension */
    ...
    /** LinuxLator app properties primary file path */
    ...
    /** LinuxLator app properties secondary file */
    public static final File TERMUX_PROPERTIES_SECONDARY_FILE = new File(TERMUX_PROPERTIES_SECONDARY_FILE_PATH);

    /** LinuxLator app properties file paths list. **DO NOT** allow these files to be modified by
    ...
    /** LinuxLator:Float app properties primary file path */
    ...
    /** LinuxLator:Float app properties secondary file */
    public static final File TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE = new File(TERMUX_FLOAT_PROPERTIES_SECONDARY_FILE_PATH);

    /** LinuxLator:Float app properties file paths list. **DO NOT** allow these files to be modified by
     * {@link android.content.ContentProvider} exposed to external apps, since they may silently
     * modify the values for security properties like {@link #PROP_ALLOW_EXTERNAL_APPS} set by users
     * without their explicit consent. */
    ...
    /** LinuxLator app and LinuxLator:Styling colors.properties file path */
    ...
    /** LinuxLator app and LinuxLator:Styling colors.properties file */
    public static final File TERMUX_COLOR_PROPERTIES_FILE = new File(TERMUX_COLOR_PROPERTIES_FILE_PATH);

    /** LinuxLator app and LinuxLator:Styling font.ttf file path */
    ...
    /** LinuxLator app and LinuxLator:Styling font.ttf file */
    public static final File TERMUX_FONT_FILE = new File(TERMUX_FONT_FILE_PATH);


    /** LinuxLator app and plugins crash log file path */
    ...
    /** LinuxLator app and plugins crash log backup file path */
    ...
    /** LinuxLator app environment file path */
    ...
    /** LinuxLator app environment temp file path */
    ...
    /*
     * LinuxLator app plugin specific paths.
     */

    /** LinuxLator app directory path to store scripts to be run at boot by LinuxLator:Boot */
    ...
    /** LinuxLator app directory to store scripts to be run at boot by LinuxLator:Boot */
    public static final File TERMUX_BOOT_SCRIPTS_DIR = new File(TERMUX_BOOT_SCRIPTS_DIR_PATH);


    /** LinuxLator app directory path to store foreground scripts that can be run by the termux launcher
     * widget provided by LinuxLator:Widget */
    ...
    /** LinuxLator app directory to store foreground scripts that can be run by the termux launcher widget provided by LinuxLator:Widget */
    public static final File TERMUX_SHORTCUT_SCRIPTS_DIR = new File(TERMUX_SHORTCUT_SCRIPTS_DIR_PATH);


    /** LinuxLator app directory basename that stores background scripts that can be run by the termux
     * launcher widget provided by LinuxLator:Widget */
    public static final String TERMUX_SHORTCUT_TASKS_SCRIPTS_DIR_BASENAME =  "tasks"; // Default: "tasks"
    /** LinuxLator app directory path to store background scripts that can be run by the termux launcher
     * widget provided by LinuxLator:Widget */
    ...
    /** LinuxLator app directory to store background scripts that can be run by the termux launcher widget provided by LinuxLator:Widget */
    public static final File TERMUX_SHORTCUT_TASKS_SCRIPTS_DIR = new File(TERMUX_SHORTCUT_TASKS_SCRIPTS_DIR_PATH);


    /** LinuxLator app directory basename that stores icons for the foreground and background scripts
     * that can be run by the termux launcher widget provided by LinuxLator:Widget */
    public static final String TERMUX_SHORTCUT_SCRIPT_ICONS_DIR_BASENAME =  "icons"; // Default: "icons"
    /** LinuxLator app directory path to store icons for the foreground and background scripts that can
     * be run by the termux launcher widget provided by LinuxLator:Widget */
    ...
    /** LinuxLator app directory to store icons for the foreground and background scripts that can be
     * run by the termux launcher widget provided by LinuxLator:Widget */
    public static final File TERMUX_SHORTCUT_SCRIPT_ICONS_DIR = new File(TERMUX_SHORTCUT_SCRIPT_ICONS_DIR_PATH);


    /** LinuxLator app directory path to store scripts to be run by 3rd party twofortyfouram locale plugin
     * host apps like Tasker app via the LinuxLator:Tasker plugin client */
    ...
    /** LinuxLator app directory to store scripts to be run by 3rd party twofortyfouram locale plugin host apps like Tasker app via the LinuxLator:Tasker plugin client */
    ...
    /*
     * LinuxLator app and plugins notification variables.
     */

    /** LinuxLator app notification channel id used by {@link TERMUX_APP.TERMUX_SERVICE} */
    public static final String TERMUX_APP_NOTIFICATION_CHANNEL_ID = "termux_notification_channel";
    /** LinuxLator app notification channel name used by {@link TERMUX_APP.TERMUX_SERVICE} */
    public static final String TERMUX_APP_NOTIFICATION_CHANNEL_NAME = LinuxLatorConstants.TERMUX_APP_NAME + " App";
    /** LinuxLator app unique notification id used by {@link TERMUX_APP.TERMUX_SERVICE} */
    public static final int TERMUX_APP_NOTIFICATION_ID = 1337;

    /** LinuxLator app notification channel id used by {@link TERMUX_APP.RUN_COMMAND_SERVICE} */
    public static final String TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID = "termux_run_command_notification_channel";
    /** LinuxLator app notification channel name used by {@link TERMUX_APP.RUN_COMMAND_SERVICE} */
    public static final String TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME = LinuxLatorConstants.TERMUX_APP_NAME + " RunCommandService";
    /** LinuxLator app unique notification id used by {@link TERMUX_APP.RUN_COMMAND_SERVICE} */
    public static final int TERMUX_RUN_COMMAND_NOTIFICATION_ID = 1338;

    /** LinuxLator app notification channel id used for plugin command errors */
    ...
    /** LinuxLator app notification channel name used for plugin command errors */
    public static final String TERMUX_PLUGIN_COMMAND_ERRORS_NOTIFICATION_CHANNEL_NAME = LinuxLatorConstants.TERMUX_APP_NAME + " Plugin Commands Errors";

    /** LinuxLator app notification channel id used for crash reports */
    public static final String TERMUX_CRASH_REPORTS_NOTIFICATION_CHANNEL_ID = "termux_crash_reports_notification_channel";
    /** LinuxLator app notification channel name used for crash reports */
    public static final String TERMUX_CRASH_REPORTS_NOTIFICATION_CHANNEL_NAME = LinuxLatorConstants.TERMUX_APP_NAME + " Crash Reports";


    /** LinuxLator app notification channel id used by {@link TERMUX_FLOAT_APP.TERMUX_FLOAT_SERVICE} */
    public static final String TERMUX_FLOAT_APP_NOTIFICATION_CHANNEL_ID = "termux_float_notification_channel";
    /** LinuxLator app notification channel name used by {@link TERMUX_FLOAT_APP.TERMUX_FLOAT_SERVICE} */
    public static final String TERMUX_FLOAT_APP_NOTIFICATION_CHANNEL_NAME = LinuxLatorConstants.TERMUX_FLOAT_APP_NAME + " App";
    /** LinuxLator app unique notification id used by {@link TERMUX_APP.TERMUX_SERVICE} */
    ...
    /*
     * LinuxLator app and plugins miscellaneous variables.
     */

    /** Android OS permission declared by LinuxLator app in AndroidManifest.xml which can be requested by
     * 3rd party apps to run various commands in LinuxLator app context */
    ...
    /** LinuxLator property defined in termux.properties file as a secondary check to PERMISSION_RUN_COMMAND
     * to allow 3rd party apps to run various commands in LinuxLator app context */
    ...
    /** The broadcast action sent when LinuxLator App opens */
    public static final String BROADCAST_TERMUX_OPENED = TERMUX_PACKAGE_NAME + ".app.OPENED";

    /** The Uri authority for LinuxLator app file shares */
    ...
    /** Environment variable prefix root for the LinuxLator app. */
    ...
    public static final class TERMUX_APP {
        ...
        /** LinuxLator apps directory path */
        ...
        /** LinuxLator app FileViewReceiverActivity class name */
        ...
        /** LinuxLator app core activity name. */
        public static final String TERMUX_ACTIVITY_NAME = TERMUX_PACKAGE_NAME + ".app.LinuxLatorActivity"; // Default: "com.termux.app.LinuxLatorActivity"

        /**
         * LinuxLator app core activity.
         */
        public static final class TERMUX_ACTIVITY {
            ...
            public static final String EXTRA_FAILSAFE_SESSION = LinuxLatorConstants.TERMUX_PACKAGE_NAME + ".app.failsafe_session"; // Default: "com.termux.app.failsafe_session"


            /** Intent action to make termux app notify user that a crash happened. */
            public static final String ACTION_NOTIFY_APP_CRASH = LinuxLatorConstants.TERMUX_PACKAGE_NAME + ".app.notify_app_crash"; // Default: "com.termux.app.notify_app_crash"


            /** Intent action to make termux reload its termux session styling */
            public static final String ACTION_RELOAD_STYLE = LinuxLatorConstants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default: "com.termux.app.reload_style"
            /** Intent {@code String} extra for what to reload for the TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent. This has been deperecated. */
            @Deprecated
            public static final String EXTRA_RELOAD_STYLE = LinuxLatorConstants.TERMUX_PACKAGE_NAME + ".app.reload_style"; // Default: "com.termux.app.reload_style"

            /**  Intent {@code boolean} extra for whether to recreate activity for the TERMUX_ACTIVITY.ACTION_RELOAD_STYLE intent. */
            public static final String EXTRA_RECREATE_ACTIVITY = TERMUX_APP.TERMUX_ACTIVITY_NAME + ".EXTRA_RECREATE_ACTIVITY"; // Default: "com.termux.app.LinuxLatorActivity.EXTRA_RECREATE_ACTIVITY"


            /** Intent action to make termux request storage permissions */
            public static final String ACTION_REQUEST_PERMISSIONS = LinuxLatorConstants.TERMUX_PACKAGE_NAME + ".app.request_storage_permissions"; // Default: "com.termux.app.request_storage_permissions"
        }
        ...
        /** LinuxLator app settings activity name. */
        ...
        /** LinuxLator app core service name. */
        public static final String TERMUX_SERVICE_NAME = TERMUX_PACKAGE_NAME + ".app.LinuxLatorService"; // Default: "com.termux.app.LinuxLatorService"

        /**
         * LinuxLator app core service.
         */
        public static final class TERMUX_SERVICE {
             ...
             * and session(s) will be seen in LinuxLator notification and can be clicked to bring new
             ...
             * and session(s) will be seen in LinuxLator notification and can be clicked to bring
        ...
        /** LinuxLator app run command service name. */
        public static final String RUN_COMMAND_SERVICE_NAME = TERMUX_PACKAGE_NAME + ".app.RunCommandService"; // LinuxLator app service to receive commands from 3rd party apps "com.termux.app.RunCommandService"

        /**
         * LinuxLator app run command service to receive commands sent by 3rd party apps.
         */
        public static final class RUN_COMMAND_SERVICE {

            /** LinuxLator RUN_COMMAND Intent help url */
    ...
    public static final class TERMUX_API_APP {
        ...
        /** LinuxLator:API app main activity name. */
        public static final String TERMUX_API_MAIN_ACTIVITY_NAME = TERMUX_API_PACKAGE_NAME + ".activities.LinuxLatorAPIMainActivity"; // Default: "com.termux.api.activities.LinuxLatorAPIMainActivity"

        /** LinuxLator:API app launcher activity name. This is an `activity-alias` for {@link #TERMUX_API_MAIN_ACTIVITY_NAME} used for launchers with {@link Intent#CATEGORY_LAUNCHER}. */
        public static final String TERMUX_API_LAUNCHER_ACTIVITY_NAME = TERMUX_API_PACKAGE_NAME + ".activities.LinuxLatorAPILauncherActivity"; // Default: "com.termux.api.activities.LinuxLatorAPILauncherActivity"
    ...
    public static final class TERMUX_BOOT_APP {
        ...
        /** LinuxLator:Boot app main activity name. */
        public static final String TERMUX_BOOT_MAIN_ACTIVITY_NAME = TERMUX_BOOT_PACKAGE_NAME + ".activities.LinuxLatorBootMainActivity"; // Default: "com.termux.boot.activities.LinuxLatorBootMainActivity"

        /** LinuxLator:Boot app launcher activity name. This is an `activity-alias` for {@link #TERMUX_BOOT_MAIN_ACTIVITY_NAME} used for launchers with {@link Intent#CATEGORY_LAUNCHER}. */
        public static final String TERMUX_BOOT_LAUNCHER_ACTIVITY_NAME = TERMUX_BOOT_PACKAGE_NAME + ".activities.LinuxLatorBootLauncherActivity"; // Default: "com.termux.boot.activities.LinuxLatorBootLauncherActivity"
    ...
    public static final class TERMUX_FLOAT_APP {
        ...
        /** LinuxLator:Float app core activity name. */
        public static final String TERMUX_FLOAT_ACTIVITY_NAME = TERMUX_FLOAT_PACKAGE_NAME + ".LinuxLatorFloatActivity"; // Default: "com.termux.window.LinuxLatorFloatActivity"

        /** LinuxLator:Float app core service name. */
        public static final String TERMUX_FLOAT_SERVICE_NAME = TERMUX_FLOAT_PACKAGE_NAME + ".LinuxLatorFloatService"; // Default: "com.termux.window.LinuxLatorFloatService"

        /**
         * LinuxLator:Float app core service.
         */
    ...
    public static final class TERMUX_STYLING_APP {
        ...
        /** LinuxLator:Styling app core activity name. */
        public static final String TERMUX_STYLING_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME + ".LinuxLatorStyleActivity"; // Default: "com.termux.styling.LinuxLatorStyleActivity"


        /** LinuxLator:Styling app main activity name. */
        public static final String TERMUX_STYLING_MAIN_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME + ".activities.LinuxLatorStylingMainActivity"; // Default: "com.termux.styling.activities.LinuxLatorStylingMainActivity"

        /** LinuxLator:Styling app launcher activity name. This is an `activity-alias` for {@link #TERMUX_STYLING_MAIN_ACTIVITY_NAME} used for launchers with {@link Intent#CATEGORY_LAUNCHER}. */
        public static final String TERMUX_STYLING_LAUNCHER_ACTIVITY_NAME = TERMUX_STYLING_PACKAGE_NAME + ".activities.LinuxLatorStylingLauncherActivity"; // Default: "com.termux.styling.activities.LinuxLatorStylingLauncherActivity"
    ...
    public static final class TERMUX_TASKER_APP {
        ...
        /** LinuxLator:Tasker app main activity name. */
        public static final String TERMUX_TASKER_MAIN_ACTIVITY_NAME = TERMUX_TASKER_PACKAGE_NAME + ".activities.LinuxLatorTaskerMainActivity"; // Default: "com.termux.tasker.activities.LinuxLatorTaskerMainActivity"

        /** LinuxLator:Tasker app launcher activity name. This is an `activity-alias` for {@link #TERMUX_TASKER_MAIN_ACTIVITY_NAME} used for launchers with {@link Intent#CATEGORY_LAUNCHER}. */
        public static final String TERMUX_TASKER_LAUNCHER_ACTIVITY_NAME = TERMUX_TASKER_PACKAGE_NAME + ".activities.LinuxLatorTaskerLauncherActivity"; // Default: "com.termux.tasker.activities.LinuxLatorTaskerLauncherActivity"
    ...
    public static final class TERMUX_WIDGET_APP {
        ...
        /** LinuxLator:Widget app main activity name. */
        public static final String TERMUX_WIDGET_MAIN_ACTIVITY_NAME = TERMUX_WIDGET_PACKAGE_NAME + ".activities.LinuxLatorWidgetMainActivity"; // Default: "com.termux.widget.activities.LinuxLatorWidgetMainActivity"

        /** LinuxLator:Widget app launcher activity name. This is an `activity-alias` for {@link #TERMUX_WIDGET_MAIN_ACTIVITY_NAME} used for launchers with {@link Intent#CATEGORY_LAUNCHER}. */
        public static final String TERMUX_WIDGET_LAUNCHER_ACTIVITY_NAME = TERMUX_WIDGET_PACKAGE_NAME + ".activities.LinuxLatorWidgetLauncherActivity"; // Default: "com.termux.widget.activities.LinuxLatorWidgetLauncherActivity"


        /**  Intent {@code String} extra for the token of the LinuxLator:Widget app shortcuts. */
        public static final String EXTRA_TOKEN_NAME = TERMUX_PACKAGE_NAME + ".shortcut.token"; // Default: "com.termux.shortcut.token"


        /**
         * LinuxLator:Widget app {@link android.appwidget.AppWidgetProvider} class.
         */

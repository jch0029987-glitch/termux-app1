...
public class LinuxLatorShellManager {

    private static LinuxLatorShellManager shellManager;
    ...
    /**
     * The foreground LinuxLatorSessions which this service manages.
     * Note that this list is observed by an activity, like LinuxLatorActivity.mLinuxLatorSessionListViewController,
     * so any changes must be made on the UI thread and followed by a call to
     * {@link ArrayAdapter#notifyDataSetChanged()}.
     */
    public final List<LinuxLatorSession> mLinuxLatorSessions = new ArrayList<>();

    /**
     * The background LinuxLatorTasks which this service manages.
     */
    public final List<AppShell> mLinuxLatorTasks = new ArrayList<>();
    ...
    public LinuxLatorShellManager(@NonNull Context context) {
     ...
     * @return Returns the {@link LinuxLatorShellManager}.
     */
    public static LinuxLatorShellManager init(@NonNull Context context) {
        if (shellManager == null)
            shellManager = new LinuxLatorShellManager(context);
     ...
     * @return Returns the {@link LinuxLatorShellManager}.
     */
    public static LinuxLatorShellManager getShellManager() {
        return shellManager;
    }

...
/**
 * The {@link LinuxLatorActivity} relies on {@link android.view.WindowManager.LayoutParams#SOFT_INPUT_ADJUST_RESIZE)}
 * set by {@link LinuxLatorTerminalViewClient#setSoftKeyboardState(boolean, boolean)} to automatically
 ...
 * activity theme. When {@link LinuxLatorActivity} {@link ViewTreeObserver.OnGlobalLayoutListener} is
 ...
 */
public class LinuxLatorActivityRootView extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {

    public LinuxLatorActivity mActivity;
    ...
    private static final String LOG_TAG = "LinuxLatorActivityRootView";

    private static int mStatusBarHeight;

    public LinuxLatorActivityRootView(Context context) {
        super(context);
    }

    public LinuxLatorActivityRootView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public LinuxLatorActivityRootView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public void setActivity(LinuxLatorActivity activity) {
        mActivity = activity;
    }
    ...
    public void onGlobalLayout() {
        ...
        View bottomSpaceView = mActivity.getLinuxLatorActivityBottomSpaceView();
        ...
        if (isVisible) {
            ...
            // Calling addLinuxLatorActivityRootViewGlobalLayoutListener with a delay fails to

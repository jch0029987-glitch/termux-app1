...
import com.termux.shared.termux.LinuxLatorConstants.TERMUX_APP.RUN_COMMAND_SERVICE;
 ...
 * plugins that contains info on command execution and forwards the extras to {@link LinuxLatorService}
...
public class RunCommandService extends Service {
        ...
        */
        ...
        if (replaceCommaAlternativeCharsInArguments) {
            ...
            if (commaAlternativeCharsInArguments == null)
                commaAlternativeCharsInArguments = LinuxLatorConstants.COMMA_ALTERNATIVE;
            // Replace any commaAlternativeCharsInArguments characters with normal commas
            DataUtils.replaceSubStringsInStringArrayItems(executionCommand.arguments, commaAlternativeCharsInArguments, LinuxLatorConstants.COMMA_NORMAL);
        }
        ...
        errmsg = LinuxLatorPluginUtils.checkIfAllowExternalAppsPolicyIsViolated(this, LOG_TAG);
        if (errmsg != null) {
            executionCommand.setStateFailed(Errno.ERRNO_FAILED.getCode(), errmsg);
            LinuxLatorPluginUtils.processPluginExecutionCommandError(this, LOG_TAG, executionCommand, true);
            return stopService();
        }
        ...
        executionCommand.executable = LinuxLatorFileUtils.getCanonicalPath(executionCommand.executable, null, true);
        ...
        if (executionCommand.workingDirectory != null && !executionCommand.workingDirectory.isEmpty()) {
            ...
            executionCommand.workingDirectory = LinuxLatorFileUtils.getCanonicalPath(executionCommand.workingDirectory, null, true);
            ...
            error = LinuxLatorFileUtils.validateDirectoryFileExistenceAndPermissions("working", executionCommand.workingDirectory,
                true, true, true,
                false, true);
            if (error != null) {
                executionCommand.setStateFailed(error);
        ...
        executableExtra = LinuxLatorFileUtils.getExpandedLinuxLatorPath(executableExtra);
        ...
        execIntent.setClass(this, LinuxLatorService.class);
    ...
    private void runStartForeground() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            startForeground(LinuxLatorConstants.TERMUX_RUN_COMMAND_NOTIFICATION_ID, buildNotification());
        }
    }
    ...
    private Notification buildNotification() {
        ...
        Notification.Builder builder =  NotificationUtils.geNotificationBuilder(this,
            LinuxLatorConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID, Notification.PRIORITY_LOW,
            LinuxLatorConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, null, null,
    ...
    private void setupNotificationChannel() {
        ...
        NotificationUtils.setupNotificationChannel(this, LinuxLatorConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_ID,
            LinuxLatorConstants.TERMUX_RUN_COMMAND_NOTIFICATION_CHANNEL_NAME, NotificationManager.IMPORTANCE_LOW);
    }
